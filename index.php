...
try {
    ...
    $stmt = $pdo->prepare("SELECT vaga_id_externo, titulo, empresa, localizacao, modelo_trabalho, resumo, DATE_FORMAT(publicado_em, '%d/%m/%Y') as publicado_em
                           FROM vagas WHERE status = 'ativa' AND origem = 'nacional'
    ...
    foreach ($vagas as $v) {
        ...
        if ($modeloRaw === 'Remote' || $modeloRaw === 'Remoto') {
            $badgeClass = 'badge-remote';
            $badgeLabel = 'Remoto';
        } elseif ($modeloRaw === 'Hybrid' || $modeloRaw === 'Híbrido' || $modeloRaw === 'Hibrido') {
        ...
        $local   = htmlspecialchars($v['localizacao'] ?: 'Remoto', ENT_QUOTES, 'UTF-8');
        $resumo  = htmlspecialchars($v['resumo'] ?: "Oportunidade como {$v['titulo']}.", ENT_QUOTES, 'UTF-8');
...
CARD;
    ...
    $vagasHtml = '<!-- vagas temporariamente indisponíveis -->';
}
?><!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<div class="mobile-menu" id="mobile-menu">
  ...
  <a class="nav-link" href="privacidade.html">Privacidade</a>
  <a class="nav-link" href="termos-de-uso.html">Termos</a>
  <a class="nav-link active" href="./usa/"><svg width="20" height="14" viewBox="0 0 18 12" style="vertical-align:middle;margin-right:6px"><rect width="18" height="12" rx="1.5" fill="#fff"/><rect y="0" width="18" height="1.09" fill="#b22234"/><rect y="2.18" width="18" height="1.09" fill="#b22234"/><rect y="4.36" width="18" height="1.09" fill="#b22234"/><rect y="6.55" width="18" height="1.09" fill="#b22234"/><rect y="8.73" width="18" height="1.09" fill="#b22234"/><rect y="10.91" width="18" height="1.09" fill="#b22234"/><rect width="7.2" height="6.55" fill="#3c3b6e"/></svg>Jobs in USA and worldwide</a>
