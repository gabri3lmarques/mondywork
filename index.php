    ...
    <div class="testimonial-grid">
      <div class="testimonial-card">
        ...
        <div class="testimonial-body">
          ...
          <div class="testimonial-author">
            <strong>Nery Neto</strong><br>Engenheiro de Visão Computacional
      ...
      <div class="testimonial-card">
        ...
        <div class="testimonial-body">
          ...
          <div class="testimonial-author">
            <strong>Barbara Abrita</strong><br>Analista de Dados em Finanças
      ...
      <div class="testimonial-card">
        ...
        <div class="testimonial-body">
          ...
          <div class="testimonial-author">
            <strong>Gabriel Marques</strong><br>Desenvolvedor Web
