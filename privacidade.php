...
<main class="main-content">
  <section class="legal-section">
    <div class="legal-container">
      ...
      <p>O Mondywork valoriza a privacidade dos seus usuários. Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos as informações pessoais fornecidas por você ao utilizar nosso site.</p>

      <h2>1. Dados que Coletamos</h2>
      <p>Podemos coletar as seguintes informações quando você utiliza nosso site:</p>
      <ul>
        <li><strong>Informações de cadastro:</strong> nome e e-mail, fornecidos voluntariamente no formulário de newsletter.</li>
        <li><strong>Dados de navegação:</strong> endereço IP, tipo de navegador, páginas acessadas, tempo de visita e outras informações coletadas automaticamente por cookies e ferramentas de analytics (Google Analytics).</li>
      </ul>

      <h2>2. Como Usamos Seus Dados</h2>
      <p>As informações coletadas são utilizadas para:</p>
      <ul>
        <li>Enviar newsletters com vagas de emprego e oportunidades (mediante cadastro voluntário).</li>
        <li>Melhorar a experiência do usuário e otimizar o site.</li>
        <li>Analisar tendências de uso e audiência.</li>
        <li>Cumprir obrigações legais e regulatórias.</li>
      </ul>

      <h2>3. Compartilhamento de Dados</h2>
      <p>Não vendemos, trocamos ou compartilhamos suas informações pessoais com terceiros, exceto:</p>
      <ul>
        <li>Quando exigido por lei ou autoridade judicial.</li>
        <li>Com provedores de serviços que nos auxiliam na operação do site (como Google Analytics e serviços de hospedagem), desde que estes concordem em manter a confidencialidade dos dados.</li>
      </ul>

      <h2>4. Cookies</h2>
      <p>Utilizamos cookies e tecnologias semelhantes para melhorar a funcionalidade do site e entender como você interage com nosso conteúdo. Você pode configurar seu navegador para recusar cookies, mas isso pode afetar algumas funcionalidades do site.</p>
      <p>Utilizamos cookies do Google Analytics para analisar o tráfego e o comportamento dos usuários. O Google pode usar esses dados conforme sua <a href="https://policies.google.com/privacy" target="_blank">Política de Privacidade</a>.</p>

      <h2>5. Armazenamento e Segurança</h2>
      <p>Adotamos medidas técnicas e organizacionais adequadas para proteger seus dados contra acesso não autorizado, alteração, divulgação ou destruição. Os dados são armazenados em servidores seguros com acesso restrito.</p>

      <h2>6. Seus Direitos</h2>
      <p>Você tem direito a:</p>
      <ul>
        <li>Solicitar acesso, correção ou exclusão dos seus dados pessoais.</li>
        <li>Solicitar a interrupção do envio de newsletters a qualquer momento (basta responder ao e-mail ou utilizar o link de descadastro).</li>
        <li>Entrar em contato conosco para esclarecer dúvidas sobre esta política.</li>
      </ul>

      <h2>7. Alterações nesta Política</h2>
      <p>Esta política pode ser atualizada periodicamente. Recomendamos que você revise esta página regularmente para se manter informado sobre como protegemos suas informações.</p>

      <h2>8. Contato</h2>
      <p>Em caso de dúvidas sobre esta Política de Privacidade, entre em contato pelo e-mail: <a href="mailto:hello@mondywork.com">hello@mondywork.com</a></p>
    </div>
  </section>
</main>
...
<div id="modal-overlay" class="modal-overlay hidden">
  <div class="modal-content" role="dialog" aria-modal="true">
    ...
    <div class="modal-footer" id="modal-footer">
      <a id="modal-apply" href="#" target="_blank" class="modal-btn">Fechar</a>
    </div>
  </div>
</div>
...
<script src="/js/app.js?v=1.7.6"></script>
</body>
</html>
