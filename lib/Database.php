...
function setupSchema(PDO $pdo, bool $force = false): void
{
    ...
    if ((int)$catCount === 0) {
        ...
        $novasCats = [
            ...
            ['redacao', 'Redação', 'Redação'],
            ['content-writer', 'Content Writer', 'Content Writer'],
            ['ecommerce-analyst', 'Ecommerce Analyst', 'Ecommerce Analyst'],
            ['ecommerce-manager', 'Ecommerce Manager', 'Ecommerce Manager'],
            ['web-master', 'Web Master', 'Web Master'],
            ['content-manager', 'Content Manager', 'Content Manager'],
            ['engenheiro-de-automacao', 'Engenheiro de Automação', 'Automation Engineer'],
            ...
            ['ui', 'UI', 'UI'],
            ['ux', 'UX', 'UX'],
            ['analista-de-negocios', 'Analista de Negócios', 'Business Analyst'],
    ...
    $novosConteudos = [
        ...
        ['audiovisual',
         ...
         'About Audiovisual',
         '<p>A área de Audiovisual é responsável pela produção, edição e criação de conteúdo em vídeo e áudio para as mais diversas plataformas. Com o crescimento exponencial de conteúdo digital, profissionais de audiovisual são fundamentais para marcas que querem se comunicar de forma visual e impactante.</p><p>As principais habilidades incluem produção e edição de vídeo (Premiere Pro, DaVinci Resolve, Final Cut), motion graphics (After Effects), animação (Blender, Cinema 4D), design de som, podcaster, live streaming (OBS Studio) e fotografia. Conhecimento de storytelling visual, ritmo e direção de arte é diferencial.</p><p>Profissionais de Audiovisual em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam motion graphics, vídeos para redes sociais e conteúdo para plataformas digitais. A área oferece oportunidades desde videomaker até diretor de audiovisual, com foco em criatividade, qualidade técnica e storytelling.</p>',
         '<p>The Audiovisual area is responsible for producing, editing, and creating video and audio content for various platforms. With the exponential growth of digital content, audiovisual professionals are fundamental for brands that want to communicate visually and impactfully.</p><p>Key skills include video production and editing (Premiere Pro, DaVinci Resolve, Final Cut), motion graphics (After Effects), animation (Blender, Cinema 4D), sound design, podcast production, live streaming (OBS Studio), and photography. Knowledge of visual storytelling, rhythm, and art direction is a differentiator.</p><p>Audiovisual professionals in technology companies are highly valued, especially those who master motion graphics, social media videos, and content for digital platforms. The field offers opportunities from videomaker to head of audiovisual, with a focus on creativity, technical quality, and storytelling.</p>'],
        ['branding',
         'Sobre a área de Branding',
         'About Branding',
         '<p>Branding é a área responsável por construir, gerenciar e fortalecer a identidade e o valor de uma marca no mercado. Profissionais de branding criam estratégias que definem como a marca é percebida pelo público, desde o logotipo até a experiência completa do cliente.</p><p>As principais habilidades incluem estratégia de marca, identidade visual, brand guidelines, posicionamento, naming, brand voice, pesquisa de mercado, brand equity e gestão de marca. Conhecimento de design gráfico (Figma, Illustrator, Photoshop), storytelling e experiência de marca é diferencial.</p><p>Profissionais de Branding em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam employer branding, digital branding e conseguem construir marcas fortes e memoráveis em mercados competitivos. A área oferece oportunidades desde designer de marca até diretor de brand, com foco em identidade, diferenciação e valor percebido.</p>',
         '<p>Branding is the area responsible for building, managing, and strengthening a brand\'s identity and market value. Branding professionals create strategies that define how the brand is perceived by the public, from the logo to the complete customer experience.</p><p>Key skills include brand strategy, visual identity, brand guidelines, positioning, naming, brand voice, market research, brand equity, and brand management. Knowledge of graphic design (Figma, Illustrator, Photoshop), storytelling, and brand experience is a differentiator.</p><p>Branding professionals in technology companies are highly valued, especially those who master employer branding, digital branding, and can build strong, memorable brands in competitive markets. The field offers opportunities from brand designer to head of brand, with a focus on identity, differentiation, and perceived value.</p>'],
        ['redacao',
         'Sobre a área de Redação',
         'About Copywriting',
         '<p>A área de Redação é responsável por criar textos persuasivos, criativos e estratégicos para diferentes canais de comunicação. Profissionais de redação transformam ideias em palavras que engajam, convertem e constroem a identidade de voz das marcas.</p><p>As principais habilidades incluem redação publicitária, copywriting, roteiro para vídeos e podcasts, escrita persuasiva, tom de voz e guidelines editoriais. Conhecimento de SEO writing, Grammarly e ferramentas de produtividade de texto é diferencial.</p><p>Profissionais de Redação em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam copy para landing pages, e-mail sequences e conteúdo para funil de conversão. A área oferece oportunidades desde redator júnior até diretor de copy, com foco em criatividade, persuasão e performance.</p>',
         '<p>The Copywriting area is responsible for creating persuasive, creative, and strategic texts for various communication channels. Copywriting professionals transform ideas into words that engage, convert, and build brand voice.</p><p>Key skills include advertising copywriting, script writing for videos and podcasts, persuasive writing, tone of voice, and editorial guidelines. Knowledge of SEO writing, Grammarly, and text productivity tools is a differentiator.</p><p>Copywriting professionals in technology companies are highly valued, especially those who master copy for landing pages, email sequences, and funnel content. The field offers opportunities from junior copywriter to head of copy, with a focus on creativity, persuasion, and performance.</p>'],
        ['content-writer',
         'Sobre a área de Content Writer',
         'About Content Writer',
         '<p>O Content Writer é o profissional responsável por criar conteúdo escrito de qualidade para sites, blogs, redes sociais e outras plataformas digitais. Ele combina habilidades de escrita com estratégia de conteúdo e SEO para atrair, engajar e converter audiências.</p><p>As principais habilidades incluem criação de conteúdo para blogs, landing pages, newsletters e redes sociais, pesquisa de palavras-chave, estratégia de conteúdo, calendário editorial e SEO writing. Conhecimento de WordPress, Surfer SEO, Ahrefs e ferramentas de analytics é diferencial.</p><p>Content Writers em empresas de tecnologia são muito valorizados, especialmente aqueles que conseguem criar conteúdo técnico acessível, evergreen content e conteúdo que gera tráfego orgânico. A área oferece oportunidades desde content writer júnior até head of content, com foco em qualidade, estratégia e performance de conteúdo.</p>',
         '<p>The Content Writer is the professional responsible for creating quality written content for websites, blogs, social media, and other digital platforms. They combine writing skills with content strategy and SEO to attract, engage, and convert audiences.</p><p>Key skills include blog content creation, landing pages, newsletters, social media content, keyword research, content strategy, editorial calendar, and SEO writing. Knowledge of WordPress, Surfer SEO, Ahrefs, and analytics tools is a differentiator.</p><p>Content Writers in technology companies are highly valued, especially those who can create accessible technical content, evergreen content, and content that generates organic traffic. The field offers opportunities from junior content writer to head of content, with a focus on quality, strategy, and content performance.</p>'],
        ['ecommerce-analyst',
         'Sobre a área de Ecommerce Analyst',
         'About Ecommerce Analyst',
         '<p>O Ecommerce Analyst é o profissional responsável por analisar dados de vendas online, comportamento do comprador e performance de lojas virtuais para guiar decisões estratégicas. Ele combina análise de dados com conhecimento de ecommerce para otimizar conversão, ticket médio e retorno sobre investimento.</p><p>As principais habilidades incluem Google Analytics (GA4), Hotjar, análise de funil de conversão, cohort analysis, segmentação de clientes, análise de pricing e métricas de ecommerce (CAC, CLV, AOV, taxa de conversão). Conhecimento de SQL, Power BI, Google Tag Manager e plataformas como Shopify e VTEX é diferencial.</p><p>Ecommerce Analysts em empresas de tecnologia são muito valorizados, especialmente aqueles que conseguem transformar dados de comportamento de compra em insights acionáveis para aumentar receita e reduzir abandono de carrinho. A área oferece oportunidades desde analista júnior até analytics manager de ecommerce.</p>',
         '<p>The Ecommerce Analyst is the professional responsible for analyzing online sales data, buyer behavior, and virtual store performance to guide strategic decisions. They combine data analysis with ecommerce knowledge to optimize conversion, average order value, and return on investment.</p><p>Key skills include Google Analytics (GA4), Hotjar, conversion funnel analysis, cohort analysis, customer segmentation, pricing analysis, and ecommerce metrics (CAC, CLV, AOV, conversion rate). Knowledge of SQL, Power BI, Google Tag Manager, and platforms like Shopify and VTEX is a differentiator.</p><p>Ecommerce Analysts in technology companies are highly valued, especially those who can turn buyer behavior data into actionable insights to increase revenue and reduce cart abandonment. The field offers opportunities from junior analyst to ecommerce analytics manager.</p>'],
        ['ecommerce-manager',
         'Sobre a área de Ecommerce Manager',
         'About Ecommerce Manager',
         '<p>O Ecommerce Manager é o profissional responsável por toda a gestão estratégica e operacional de lojas virtuais e marketplaces. Ele lidera equipes, define estratégias de preço, promoção e catálogo, e acompanha a performance de vendas online em múltiplas plataformas.</p><p>As principais habilidades incluem gestão de catálogo, pricing dinâmico, campanhas sazonais (Black Friday, Cyber Monday), gestão de marketplace (Amazon, Mercado Livre, Shopee, Magalu), tráfego pago, CRO e gestão de equipe. Conhecimento de Shopify, VTEX, WooCommerce, Google Ads, Meta Ads e métricas de performance é diferencial.</p><p>Ecommerce Managers em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam gestão multi-marketplace, otimização de checkout e estratégias de mobile commerce. A área oferece oportunidades desde gerente de ecommerce até diretor de vendas online, com foco em receita, experiência do cliente e crescimento.</p>',
         '<p>The Ecommerce Manager is the professional responsible for the entire strategic and operational management of online stores and marketplaces. They lead teams, define pricing, promotion, and catalog strategies, and monitor online sales performance across multiple platforms.</p><p>Key skills include catalog management, dynamic pricing, seasonal campaigns (Black Friday, Cyber Monday), marketplace management (Amazon, Mercado Livre, Shopee, Magalu), paid traffic, CRO, and team management. Knowledge of Shopify, VTEX, WooCommerce, Google Ads, Meta Ads, and performance metrics is a differentiator.</p><p>Ecommerce Managers in technology companies are highly valued, especially those who master multi-marketplace management, checkout optimization, and mobile commerce strategies. The field offers opportunities from ecommerce manager to head of ecommerce, with a focus on revenue, customer experience, and growth.</p>'],
        ['web-master',
         'Sobre a área de Web Master',
         'About Web Master',
         '<p>O Web Master é o profissional responsável pela manutenção, segurança e performance técnica de sites e aplicações web. Ele gerencia servidores, infraestrutura de hospedagem, monitoramento de uptime e garante que tudo funcione com rapidez e disponibilidade.</p><p>As principais habilidades incluem gestão de servidores (Apache, Nginx), hospedagem (AWS, Google Cloud, Azure), CDN (Cloudflare), SSL, DNS, segurança web (WAF, firewall), performance (Core Web Vitals, cache, compressão) e versionamento (Git, CI/CD). Conhecimento de Docker, WordPress, cPanel e monitoramento (Sentry, New Relic) é diferencial.</p><p>Web Masters em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam DevOps, SRE e conseguem garantir uptime e performance em escala. A área oferece oportunidades desde webmaster júnior até SRE e infrastructure engineer, com foco em confiabilidade, segurança e velocidade.</p>',
         '<p>The Web Master is the professional responsible for maintaining, securing, and ensuring the technical performance of websites and web applications. They manage servers, hosting infrastructure, uptime monitoring, and ensure everything runs fast and reliably.</p><p>Key skills include server management (Apache, Nginx), hosting (AWS, Google Cloud, Azure), CDN (Cloudflare), SSL, DNS, web security (WAF, firewall), performance (Core Web Vitals, cache, compression), and versioning (Git, CI/CD). Knowledge of Docker, WordPress, cPanel, and monitoring (Sentry, New Relic) is a differentiator.</p><p>Web Masters in technology companies are highly valued, especially those who master DevOps, SRE, and can guarantee uptime and performance at scale. The field offers opportunities from junior webmaster to SRE and infrastructure engineer, with a focus on reliability, security, and speed.</p>'],
        ['content-manager',
         'Sobre a área de Content Manager',
         'About Content Manager',
         '<p>O Content Manager é o profissional responsável por liderar toda a estratégia, produção e gestão de conteúdo de uma organização. Ele define a estratégia editorial, coordena equipes de redação e garante que o conteúdo esteja alinhado com os objetivos de negócio e a identidade da marca.</p><p>As principais habilidades incluem estratégia de conteúdo, planejamento editorial, content audit, buyer persona, customer journey, content ops, governança de conteúdo, métricas de performance (ROI, engajamento, tráfego orgânico) e gestão de equipe. Conhecimento de WordPress, Contentful, Notion e ferramentas de analytics é diferencial.</p><p>Content Managers em empresas de tecnologia são muito valorizados, especialmente aqueles que conseguem alinhar conteúdo com funil de conversão, liderar equipes multidisciplinares e usar dados para otimizar estratégia editorial. A área oferece oportunidades desde content manager até diretor de conteúdo, com foco em estratégia, qualidade e escala.</p>',
         '<p>The Content Manager is the professional responsible for leading the entire content strategy, production, and management of an organization. They define the editorial strategy, coordinate writing teams, and ensure content aligns with business goals and brand identity.</p><p>Key skills include content strategy, editorial planning, content audit, buyer persona, customer journey, content ops, content governance, performance metrics (ROI, engagement, organic traffic), and team management. Knowledge of WordPress, Contentful, Notion, and analytics tools is a differentiator.</p><p>Content Managers in technology companies are highly valued, especially those who can align content with conversion funnels, lead multidisciplinary teams, and use data to optimize editorial strategy. The field offers opportunities from content manager to head of content, with a focus on strategy, quality, and scale.</p>'],
        ['engenheiro-de-automacao',
         'Sobre a área de Engenheiro de Automação',
         'About Automation Engineer',
         '<p>O Engenheiro de Automação é o profissional responsável por projetar, desenvolver e implementar soluções que automatizam processos manuais e repetitivos em TI, infraestrutura, testes e operações. Ele combina conhecimento de programação com visão de DevOps e SRE para eliminar tarefas manuais e aumentar a eficiência operacional.</p><p>As principais habilidades incluem Infrastructure as Code (Terraform, Ansible, Pulumi), CI/CD (Jenkins, GitHub Actions, GitLab CI), automação de testes (Selenium, Cypress, Playwright), automação de rede (Netconf, SDN), RPA (UiPath, Power Automate) e scripting (Python, Bash, PowerShell). Conhecimento de Kubernetes, GitOps (ArgoCD, Flux) e plataforma de automação é diferencial.</p><p>Engenheiros de Automação em empresas de tecnologia são muito valorizados, especialmente aqueles que conseguem criar pipelines de deploy automatizados, infraestrutura auto-healing e plataformas internas de desenvolvimento (IDP). A área oferece oportunidades desde automation engineer júnior até automation architect e head of automation.</p>',
         '<p>The Automation Engineer is the professional responsible for designing, developing, and implementing solutions that automate manual and repetitive processes in IT, infrastructure, testing, and operations. They combine programming knowledge with DevOps and SRE vision to eliminate manual tasks and increase operational efficiency.</p><p>Key skills include Infrastructure as Code (Terraform, Ansible, Pulumi), CI/CD (Jenkins, GitHub Actions, GitLab CI), test automation (Selenium, Cypress, Playwright), network automation (Netconf, SDN), RPA (UiPath, Power Automate), and scripting (Python, Bash, PowerShell). Knowledge of Kubernetes, GitOps (ArgoCD, Flux), and automation platforms is a differentiator.</p><p>Automation Engineers in technology companies are highly valued, especially those who can create automated deployment pipelines, self-healing infrastructure, and internal developer platforms (IDP). The field offers opportunities from junior automation engineer to automation architect and head of automation.</p>'],
        ['scrum-master',
         'Sobre a área de Scrum Master',
         'About Scrum Master',
         '<p>O Scrum Master é o profissional responsável por facilitar a adoção do Scrum e de práticas ágeis dentro de times de desenvolvimento. Ele atua como servant leader, removendo impedimentos, promovendo melhoria contínua e garantindo que os eventos e cerimônias do Scrum aconteçam da melhor forma possível.</p><p>As principais habilidades incluem facilitação de eventos (sprint planning, daily, review, retrospective), gestão de backlog, coaching de time, mediação de conflitos e métricas ágeis (velocity, burndown, cycle time). Conhecimento de Jira, Trello, Azure DevOps e frameworks como Kanban, XP e SAFe é diferencial.</p><p>Scrum Masters em empresas de tecnologia são muito valorizados, especialmente aqueles que conseguem promover autonomia nos times, criar ambientes com segurança psicológica e liderar transformações ágeis em escala. A área oferece oportunidades desde scrum master júnior até agile coach, head of agile e diretor de transformação ágil.</p>',
         '<p>The Scrum Master is the professional responsible for facilitating the adoption of Scrum and agile practices within development teams. They act as servant leaders, removing impediments, promoting continuous improvement, and ensuring Scrum events and ceremonies happen in the best possible way.</p><p>Key skills include event facilitation (sprint planning, daily, review, retrospective), backlog management, team coaching, conflict resolution, and agile metrics (velocity, burndown, cycle time). Knowledge of Jira, Trello, Azure DevOps, and frameworks like Kanban, XP, and SAFe is a differentiator.</p><p>Scrum Masters in technology companies are highly valued, especially those who can promote team autonomy, create psychologically safe environments, and lead agile transformations at scale. The field offers opportunities from junior scrum master to agile coach, head of agile, and director of agile transformation.</p>'],
        ['web-designer',
         'Sobre a área de Web Designer',
         'About Web Designer',
         '<p>O Web Designer é o profissional responsável por criar interfaces visuais de sites, aplicações web e landing pages, combinando estética, usabilidade e experiência do usuário. Ele transforma necessidades de negócio em layouts funcionais e responsivos que comunicam a identidade da marca.</p><p>As principais habilidades incluem UI design, design responsivo, prototipação (Figma, Sketch, Adobe XD), wireframing, design systems, acessibilidade (WCAG), information architecture e conhecimento básico de HTML/CSS. Conhecimento de UX design, motion design e front-end é diferencial.</p><p>Web Designers em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam design systems, design tokens e conseguem criar interfaces que convertem e engajam. A área oferece oportunidades desde web designer júnior até product designer e design lead.</p>',
         '<p>The Web Designer is the professional responsible for creating visual interfaces for websites, web applications, and landing pages, combining aesthetics, usability, and user experience. They transform business needs into functional and responsive layouts that communicate brand identity.</p><p>Key skills include UI design, responsive design, prototyping (Figma, Sketch, Adobe XD), wireframing, design systems, accessibility (WCAG), information architecture, and basic HTML/CSS knowledge. Knowledge of UX design, motion design, and front-end is a differentiator.</p><p>Web Designers in technology companies are highly valued, especially those who master design systems, design tokens, and can create interfaces that convert and engage. The field offers opportunities from junior web designer to product designer and design lead.</p>'],
        ['designer-grafico',
         'Sobre a área de Designer Gráfico',
         'About Graphic Designer',
         '<p>O Designer Gráfico é o profissional responsável por criar peças visuais para comunicação impressa e digital, desde identidade visual e logotipos até materiais de marketing e embalagens. Ele combina criatividade com técnica para transmitir mensagens de forma visual e impactante.</p><p>As principais habilidades incluem Adobe Photoshop, Illustrator e InDesign, CorelDRAW, design de identidade visual, tipografia, teoria das cores, packaging design e motion graphics. Conhecimento de ilustração vetorial, impressão offset/digital e produção gráfica é diferencial.</p><p>Designers Gráficos em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam design para redes sociais, infográficos e conseguem criar materiais que fortalecem a identidade visual da marca. A área oferece oportunidades desde designer gráfico júnior até art director e design director.</p>',
         '<p>The Graphic Designer is the professional responsible for creating visual pieces for print and digital communication, from visual identity and logos to marketing materials and packaging. They combine creativity with technique to convey messages visually and impactfully.</p><p>Key skills include Adobe Photoshop, Illustrator, and InDesign, CorelDRAW, visual identity design, typography, color theory, packaging design, and motion graphics. Knowledge of vector illustration, offset/digital printing, and print production is a differentiator.</p><p>Graphic Designers in technology companies are highly valued, especially those who master social media design, infographics, and can create materials that strengthen brand visual identity. The field offers opportunities from junior graphic designer to art director and design director.</p>'],
        ['cloud-solutions',
         'Sobre a área de Cloud Solutions',
         'About Cloud Solutions',
         '<p>A área de Cloud Solutions é responsável por projetar, implementar e gerenciar infraestrutura e serviços em nuvem (AWS, Azure, GCP) para empresas. Profissionais de cloud arquitetam soluções escaláveis, seguras e otimizadas em custo, desde migrações de data centers até arquiteturas serverless e multi-cloud.</p><p>As principais habilidades incluem IaC (Terraform, CloudFormation), containers (Docker, Kubernetes), serverless (Lambda, Cloud Functions), bancos de dados gerenciados (RDS, DynamoDB, BigQuery), redes cloud (VPC, CDN, load balancer) e segurança (IAM, WAF, KMS). Conhecimento de FinOps, cloud governance e certificações AWS/Azure/GCP é diferencial.</p><p>Profissionais de Cloud Solutions em empresas de tecnologia são muito valorizados, especialmente aqueles que dominam arquiteturas multi-cloud, FinOps e conseguem otimizar custos enquanto mantêm performance e segurança. A área oferece oportunidades desde cloud engineer até cloud solutions architect, head of cloud e chief cloud architect.</p>',
         '<p>The Cloud Solutions area is responsible for designing, implementing, and managing cloud infrastructure and services (AWS, Azure, GCP) for companies. Cloud professionals architect scalable, secure, and cost-optimized solutions, from data center migrations to serverless and multi-cloud architectures.</p><p>Key skills include IaC (Terraform, CloudFormation), containers (Docker, Kubernetes), serverless (Lambda, Cloud Functions), managed databases (RDS, DynamoDB, BigQuery), cloud networking (VPC, CDN, load balancer), and security (IAM, WAF, KMS). Knowledge of FinOps, cloud governance, and AWS/Azure/GCP certifications is a differentiator.</p><p>Cloud Solutions professionals in technology companies are highly valued, especially those who master multi-cloud architectures, FinOps, and can optimize costs while maintaining performance and security. The field offers opportunities from cloud engineer to cloud solutions architect, head of cloud, and chief cloud architect.</p>'],
    ];
