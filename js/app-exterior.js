(function() {
    ...
    function renderCard(v) {
        ...
        var modeloHtml = modelo
            ? '<span class="badge badge-' + (rawModelo ? rawModelo.toLowerCase() : '') + '">' + escapeHtml(modelo) + '</span>'
            : '';
            ...
            '<div class="card-inner">' +
                ...
                '<div class="card-body">' +
                    ...
                    '<div class="card-info-row">' +
                        ...
                        dateHtml +
                    '</div>' +
                    '<p class="card-resumo">' + 'This ' + escapeHtml(v.titulo) + ' position is ' + escapeHtml(modelo).toLowerCase() + '. Check the details and apply!' + '</p>' +
