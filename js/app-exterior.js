        ...
        card.innerHTML =
            ...
            '<div class="job-card-interactions" data-vaga-id="' + vagaId + '">' +
                '<div class="job-card-reactions">' +
                    '<button type="button" class="card-reaction-btn" data-tipo="like" data-vaga-id="' + vagaId + '" title="Like"><span class="card-reaction-emoji">👍</span><span class="card-reaction-count"></span></button>' +
                    '<button type="button" class="card-reaction-btn" data-tipo="dislike" data-vaga-id="' + vagaId + '" title="Dislike"><span class="card-reaction-emoji">👎</span><span class="card-reaction-count"></span></button>' +
                    '<button type="button" class="card-reaction-btn" data-tipo="love" data-vaga-id="' + vagaId + '" title="Loved it"><span class="card-reaction-emoji">❤️</span><span class="card-reaction-count"></span></button>' +
                    '<button type="button" class="card-reaction-btn" data-tipo="angry" data-vaga-id="' + vagaId + '" title="Angry"><span class="card-reaction-emoji">😡</span><span class="card-reaction-count"></span></button>' +
                '</div>' +
