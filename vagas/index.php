  ...
  <section class="section">
    ...
    <div class="job-grid">
      <div class="job-list" id="vagas-container">
        <div class="flex align-center justify-center overflow-hidden" style="height:120px;width:100%;margin-left:auto;margin-right:auto;background-color:#E6E7FC;border-radius:12px;">
          <script>
            atOptions = {
